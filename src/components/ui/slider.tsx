  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-muted bg-muted relative grow overflow-hidden rounded-md data-horizontal:h-3 data-horizontal:w-full data-vertical:h-full data-vertical:w-3"
      >
